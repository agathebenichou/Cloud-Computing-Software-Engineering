...
def test_get_not_exists_dish_by_id():
    ...
    response = http_get(f"dishes/{NOT_EXISTS_DISH_ID}")
...
def test_get_not_exists_dish_by_name():
    ...
    response = http_get(f"dishes/{NOT_EXISTS_DISH}")
    assert_err_code(response, error_code=404)
    assert_ret_value(response, returned_value=-5)
...
def test_get_dish_by_id():
    ...
    response = http_get(f"dishes/{milk_id}")
...
def test_get_dish_by_name():
    ...
    add_dish(dish_name)
    response = http_get(f"dishes/{dish_name}")
    assert_err_code(response, error_code=200)
...
def test_add_exists_dish():
    DISH_NAME = "water"
    add_dish(DISH_NAME)
    response = http_post("dishes", {"name": DISH_NAME})
    assert_err_code(response, error_code=422)
...
def test_delete_dish_by_id():
    ...
    response = http_delete(f"dishes/{dish_id}")
    assert_err_code(response, error_code=200)
...
def test_delete_dish_by_name():
    ...
    response = http_delete(f"dishes/{DISH_NAME}")
    assert_err_code(response, error_code=200)
    assert_ret_value(response, dish_id)
...
def test_add_meal_missing_parameter():
    ...
    response = http_post("meals", MISSING_APPTIZER)
    assert_err_code(response, error_code=422)
...
def test_get_meal_by_id():
    ...
    response = http_get(f"meals/{meal_id}")
    assert_err_code(response, error_code=200)
...
def test_get_meal_by_name():
    ...
    response = http_get(f"meals/{MEAL_NAME}")
    assert_err_code(response, error_code=200)
...
def test_change_meal():
    ...
    response = http_put(f"meals/{meal_id}", meal)
    assert_err_code(response, error_code=200)
...
def test_delete_meal_by_id():
    ...
    response = http_delete(f"meals/{meal_id}")
    assert_err_code(response, error_code=200)
...
def test_delete_meal_by_name():
    ...
    response = http_delete(f"meals/{MEAL_NAME}")
    assert_err_code(response, error_code=200)
    assert response.json() == meal_id
    assert_not_existed_meal(meal_id)
...
def test_delete_no_existed_meal_by_id():
    ...
    response = http_delete(f"meals/{NOT_EXISTED_MEAL}")
    assert_err_code(response, error_code=404)
    assert_ret_value(response, returned_value=-5)
...
def test_delete_used_dish():
    ...
    response = http_delete(f"dishes/{ravioli_dish_id}")
    assert_err_code(response, error_code=200)

    meal = http_get(f"meals/{meal_id}").json()
